...
If you've made significant contributions to the SDK, please reach out to `support@tastyware.dev <mailto:support@tastyware.dev>`_ and ask for a free API key. Otherwise, if you've benefitted from this project and would make good use of the paper API, please consider subscribing--it's a great way to support the project!
